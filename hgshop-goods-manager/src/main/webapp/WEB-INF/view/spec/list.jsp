    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">添加规格</h5>
         <button type="button" onclick="addProp('#addspec')" class="btn btn-success"> 添加属性</button>
        	...
        	<form id="addspec">
        		 <div class="form-group">
  				...
  				<div class="form-group form-group-proper">
    				...
    				<input value="删除" type="button" onclick="$(this).parent().remove()"class="btn btn-danger" />
  				</div>
...
<div class="modal fade" id="staticBackdropUpdate" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">添加规格</h5>
         <button type="button" onclick="addProp('#updatespec')" class="btn btn-success"> 添加属性</button>
	...
	*/
	function delSec(id){
		if(confirm("您确认删除该条数据么？")){
			$.post("/spec/delSpec",{id:id},function(flag){
				if(flag){
					alert("删除成功");
					refresh();
				}else{
	...
	*/
	function delBatch(){
		...
		if(confirm("您确认删除这些数据么？")){
			$.post("/spec/delSpecBatch",{ids:delIds},function(flag){
				if(flag){
					alert("删除成功");
					refresh();
				}else{
